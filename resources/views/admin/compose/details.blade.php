...
<div class="container mt-4">
    <a href="{{ route('admin.outbox') }}" class="btn btn-sm btn-secondary mb-3">← Back to Outbox</a>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            @if ($message->attachment_path)
                <div class="mt-3">
                    <a href="{{ route('admin.messages.preview', $message->id) }}" target="_blank" class="btn btn-outline-primary btn-sm">View</a>
                    <a href="{{ route('admin.messages.download', $message->id) }}" class="btn btn-outline-success btn-sm">Export</a>
                </div>
            @endif
        </div>
    </div>
