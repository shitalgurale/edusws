...
<form action="{{ route('admin.addons.lesson_view_update', ['id' => $lesson_details->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @php
        ...
        <div class="dv_none" id="video">
            ...
            <div class="dv_none" id = "youtube_vimeo">
                <div class="form-group mb-2">
                    ...
                    <label class="form-label text-danger mt-2 d-hidden" id = "invalid_url">{{ get_phrase('Invalid url').'. '.get_phrase('Your video source has to be either youtube or vimeo') }}</label>
                </div>
