...
<form action="{{ route('admin.addons.lesson_create', ['id' => $course_id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="dv_none" id="video">
        ...
        <div class="dv_none" id = "youtube_vimeo">
            <div class="form-group mb-3">
                ...
                <label class="form-label mt-2 text-danger d-hidden" id = "invalid_url">{{ get_phrase('Invalid url').'. '.get_phrase('Your video source has to be either youtube or vimeo') }}</label>
            </div>
