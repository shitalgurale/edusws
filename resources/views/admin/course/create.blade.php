...
<div class="row">
	<div class="col-12">
      ...
      <div class="col-md-12 pb-3">
        ...
        <form class="required-form" action="{{ route('admin.addons.course_create') }}" method="post" enctype="multipart/form-data">
          @csrf
          <ul
                ...
                <div class="col-xl-7">
                  ...
                  >
                    ...
                    <div class="eCard d-block text-center bg-light col-sm-10 col-md-9 col-lg-6 thumbnail-margin">
                      <img src="{{ asset('assets/uploads/course_thumbnails/course-thumbnail.png') }}" class="pt-2" width="290px" height="290px"
                          alt="...">
