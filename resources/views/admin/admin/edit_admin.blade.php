    ...
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.update', ['id' => $user->id]) }}">
        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                ...
                <input type="text" class="form-control eForm-control" value="{{ $hrUser->emp_bioid ?? '' }}" id="emp_bioid" name="emp_bioid" required>
            </div>             
            ...
            <div class="fpb-7">
                ...
                <input type="number" class="form-control eForm-control" id="joining_salary" value="{{ $hrUser->joining_salary ?? '' }}" name="joining_salary" required>
            </div>
