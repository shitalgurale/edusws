                  ...
                  <div class="dashboard_ShortListItem">
                    <div class="dsHeader d-flex justify-content-between align-items-center">
                      ...
                      <a href="{{ route('admin.subscription') }}">
                        <img src="{{ asset('assets/images/forward.png') }}" alt="" />
                      </a>
                    </div>
                    ...
                    <div class="dsBody d-flex justify-content-between align-items-center">
                      <div class="ds_item_details">
                        ...
                        <h4 class="dashboard-count">
                          {{ $current_package->name ?? 'N/A' }}
                        </h4>
                        <p class="total_info">{{ get_phrase('Current Package') }}</p>
                      </div>
                
                      <div class="dashboard-icon">
                        <img src="{{ asset('assets/images/Subscription.png') }}" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
	            ...
	            <div class="col-md-3">
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  ...
	                  <div class="dashboard-icon">
	                    <img
	                      src="{{ asset('assets/images/Fee_manager_icon.png') }}"
	                      alt=""
	                    />
	                  </div>
	                </div>
	            ...
	            <div class="col-md-3"> 
                  <div class="dashboard_ShortListItem">
                    ...
                    <div class="dsBody d-flex justify-content-between align-items-center">
                      ...
                      <div class="ds_item_icon">
                        <img
                          src="{{ asset('assets/images/Staff_icon1.png') }}"
                          alt=""
                        />
                      </div>
                    </div>
	            ...
	            <div class="col-md-3">
	              <div class="dashboard_ShortListItem">
	                ...
	                >
	                  ...
	                  <div class="ds_item_icon">
	                    <img
	                      src="{{ asset('assets/images/driving-licence_resized_60x60.png') }}"
	                      alt=""
	                    />
	                  </div>
	                </div>
	            ...
	            <div class="col-md-3"> 
                  <div class="dashboard_ShortListItem">
                    ...
                    <div class="dsBody d-flex justify-content-between align-items-center">
                      ...
                      <div class="ds_item_icon">
                        <img
                          src="{{ asset('assets/images/bus_resized_60x60.png') }}"
                          alt=""
                        />
                      </div>
                    </div>
