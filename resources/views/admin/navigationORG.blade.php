        ...
        <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('payroll/create/payslip*') || request()->is('attendence/list*') || request()->is('payroll/list*') || request()->is('hr/user/roles*') || request()->is('hr/user/list*')  ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
               ...
               <li>
                ...
                <li>
                    <a class="{{ (request()->is('hr/user/list/staff_list')) ? 'active' : '' }}" href="{{ route('hr.showAllStaff') }}">
                        <span>
                            {{ get_phrase('All Staff') }}
                        </span>
                        <!-- <span class="badge bg-success m-1" style="">{{ get_phrase('Addon') }}</span> -->
                    </a>
                </li>
                ...
                <li>
                    <a class="{{ (request()->is('attendence/list')) ? 'active' : '' }}" href="{{ route('hr_daily_attendence.hr_daily_attendance') }}">
                        <span>{{ get_phrase('Daily Attendance') }}</span>
