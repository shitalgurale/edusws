				...
				<div class="d-flex flex-column">
	          	...
	          	<div class="row mb-3">
	                <div class="expense_add">
	                    <a href="javascript:;" class="btn btn-outline-primary float-end m-1" data-bs-toggle="tooltip" onclick="rightModal('{{ route('admin.fee_manager.open_modal', ['value' => 'single']) }}', '{{ get_phrase('Add Single Invoice') }}')"><i class="bi bi-plus"></i>{{ get_phrase('Add Fee Receipt') }}</a>
