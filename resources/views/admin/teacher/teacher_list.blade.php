                  ...
                  <span>{{ get_phrase('Address') }}:</span> {{ $info->address }}
                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('admin.teacher_edit_modal', ['id' => $teacher->id]) }}', '{{ get_phrase('Edit Teacher') }}')">{{ get_phrase('Edit') }}</a>
                              </li>
                              <li>
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td>
            <div class="dAdmin_info_name min-w-250px">
              <p><span>{{ get_phrase('Phone') }}:</span> {{ $phone }}</p>
              <p>
                <span>{{ get_phrase('Address') }}:</span> {{ $address }}
              </p>
            </div>
          </td>
          <td>
