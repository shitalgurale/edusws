...
<body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <!-- Compose-->
        <!--<li class="nav-links-li {{ request()->is('admin/compose') ? 'showMenu':'' }}">
            <div class="iocn-link">
                <a href="{{ route('admin.compose') }}">
                    ...
                    <span class="link_name">{{ get_phrase('Compose') }}</span>
                </a>
            </div>
        </li>-->

        <!-- OutBox -->
    <!--    <li class="nav-links-li {{ request()->is('admin/outbox') ? 'showMenu':'' }}">
    <div class="iocn-link">
        <a href="{{ route('admin.outbox') }}">
            <div class="sidebar_icon">
            ...
            <span class="link_name">{{ get_phrase('Outbox') }}</span>
        </a>
    </div>
</li>  -->
...
-->
        ...
        <li class="nav-links-li {{ request()->is('admin/attendance*') || request()->is('admin/class_list*') || request()->is('admin/routine*') || request()->is('admin/subject*') || request()->is('admin/syllabus*') || request()->is('admin/gradebook*') || request()->is('admin/class_room*') || request()->is('admin/department*') ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
              ...
              @endif
              @if(empty($user->menu_permission) || in_array('admin.attendance.student_daily_attendance', $menu_permission))
                <li>
                  <a class="{{ request()->routeIs('admin.attendance.student_daily_attendance') ? 'active' : '' }}" 
                     href="{{ route('admin.attendance.student_daily_attendance') }}">
                    <span>{{ get_phrase('Daily Attendance') }}</span>
                  </a>
                </li>
                @endif
        ...
        <li class="nav-links-li {{ request()->is('admin/fee_manager*') || request()->is('admin/offline_payment/pending*')|| request()->is('admin/expense_category*') || request()->is('admin/expenses*') ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
              ...
              <li><a class="{{ (request()->is('admin/offline_payment/pending*')) ? 'active' : '' }}" href="{{ route('admin.offline_payment_pending') }}"><span>
                {{ get_phrase('Pending Fee Request') }}
              </span></a></li>
              @endif
        ...
        <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('payroll/create/payslip*') || request()->is('attendence/list*') || request()->is('payroll/list*') || request()->is('hr/user/roles*') || request()->is('hr/user/list*')  ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="{{ request()->routeIs('hr.userlist_index') ? 'active' : '' }}" href="{{ route('hr.userlist_index') }}">
                        <span>{{ get_phrase('User List') }}</span>
                    </a>
                </li>
                
                <li>
                    <a class="{{ request()->routeIs('hr.showAllStaff') ? 'active' : '' }}" href="{{ route('hr.showAllStaff') }}">
                        <span>{{ get_phrase('All Staff') }}</span>
                    </a>
                </li>
                
                <li>
                    <a class="{{ request()->routeIs('hr.list_of_attendence') ? 'active' : '' }}" href="{{ route('hr.list_of_attendence') }}">
                        <span>{{ get_phrase('Monthly Attendance') }}</span>
                    </a>
                </li>
                
                <li>
                    <a class="{{ request()->routeIs('admin.attendance.hr_daily_attendance') ? 'active' : '' }}" href="{{ route('admin.attendance.hr_daily_attendance') }}">
                        <span>{{ get_phrase('Daily Attendance') }}</span>
                    </a>
                </li>
        ...
        <li class="nav-links-li {{ request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') || request()->is('admin/feedback-list*') ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
              ...
              @if(empty($user->menu_permission) || in_array('admin.events.list', $menu_permission))
              <li>
                <a class="{{ (request()->is('admin/certificate')) ? 'active' : '' }}" href="{{ route('admin.certificate.index') }}"><span>{{ get_phrase('Certificate') }}
                </span></a>
              </li>
              @endif
       ...
       <li class="nav-links-li {{ request()->is('admin/compose') || request()->is('admin/outbox') ? 'showMenu' : '' }}">
    <div class="iocn-link">
        <a href="#">
            <div class="sidebar_icon">
                <!-- 📢 Broadcast icon -->
            ...
            <span class="link_name">{{ get_phrase('Broadcast') }}</span>
        </a>
        <span class="arrow">
    ...
    <ul class="sub-menu">
        @if(empty($user->menu_permission) || in_array('admin.compose', $menu_permission))
        <li>
            <a class="{{ request()->is('admin/compose') ? 'active' : '' }}" href="{{ route('admin.compose') }}">
                {{ get_phrase('Compose') }}
            </a>
        </li>
        @endif

        @if(empty($user->menu_permission) || in_array('admin.outbox', $menu_permission))
        <li>
            <a class="{{ request()->is('admin/outbox') ? 'active' : '' }}" href="{{ route('admin.outbox') }}">
                {{ get_phrase('Outbox') }}
            </a>
        </li>
        @endif
