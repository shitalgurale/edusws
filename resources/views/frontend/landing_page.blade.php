            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-7">
                ...
                <div class="header-btn">
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}" class="signUp-btn">{{ get_phrase('Login') }}</a>                        
                        <!--<a class="signUp-btn" href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{ get_phrase('Register') }}</a>-->
                        <!--<a class="signUp-btn disabled" href="#" tabindex="-1" aria-disabled="true" style="pointer-events: none; opacity: 0.5;">{{ get_phrase('Register') }}</a>                        -->
                    @endif
