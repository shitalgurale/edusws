				...
				<div class="d-flex flex-column">
	          	...
	          	<div class="row mb-3">
	                <div class="expense_add">
	                    <a href="javascript:;" class="btn btn-outline-primary float-end m-1" data-bs-toggle="tooltip" onclick="rightModal('{{ route('accountant.fee_manager.open_modal', ['value' => 'single']) }}', '{{ get_phrase('Add Single Invoice') }}')"><i class="bi bi-plus"></i>{{ get_phrase('Add Fee Receipt') }}</a>
					        ...
					        @else
						        <div class="form-group">
					              <select name="status" id="status" class="form-select eForm-select eChoice-multiple-with-remove">
					                ...
					                <option value="unpaid">{{ get_phrase('Partial paid') }}</option>
