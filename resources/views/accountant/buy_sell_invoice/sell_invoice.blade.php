            ...
            <div class="eSection-wrap-2">
                <div id="printableDiv">
                    ...
                    <div class="d-flex justify-content-between">
                        <h4 class="invoice_title pb-21">{{ get_phrase('Sell Invoice') }}</h4>
                        ...
                        <div class="col-sm-7">
                            <div class="invoice_details">
                                <div class="item">
                                    ...
                                    <span class="title">
                                        {{ get_phrase($sell_invoice['product_name']) }},
                                        {{ get_phrase($sell_invoice['category_name']) }}
                                    </span>
                        ...
                        <div class="col-sm-5">
                            <div class="invoice_details text-sm-end">
                                <div class="item">
                                    ...
                                    <div class="title">{{ sprintf('%08d', $sell_invoice['list_id']) }}</div>
                                </div>
                                <div class="item">
                                    <p class="sub-title">{{ get_phrase('Date') }}</p>
                                    <div class="title">{{ get_phrase(date('m-d-y', $sell_invoice->date)) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table eTable eTable-2 tbody-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <p class="row-number">{{ get_phrase($sell_invoice['list_id']) }}</p>
                                            </th>


                                            <td>
                                                <div class="dAdmin_info_name min-w-100px">
                                                    <p>{{ get_phrase($sell_invoice['product_name']) }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-100px">
                                                    <p>{{ get_phrase($sell_invoice['category_name']) }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-100px">
                                                    <p>{{ get_phrase($sell_invoice['quantity']) }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-100px">
                                                    <p>{{ get_phrase($sell_invoice['price']) }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dAdmin_info_name min-w-100px">
                                                    <p>{{ get_phrase($sell_invoice['total_price']) }}</p>
                                                </div>
                                            </td>
                                    ...
                                    <table class="table eTable eTable-2">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dAdmin_info_name">
                                                        <p><span>{{ get_phrase($sell_invoice['total_price']) }}</span>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
