                    ...
                    <td>
                        <div class="adminTable-action">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                <li>
                                    <a class="dropdown-item" href="{{ route('student.studentFeeinvoice', ['id' => $invoice['id']]) }}" target="_blank">
                                ...
                                <!-- @if ($status == 'unpaid' || $invoice['paid_amount'] < $actual_total)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.FeePayment', ['id' => $invoice['id']]) }}">
                                            {{ get_phrase('Pay') }}
                                        </a>
                                    </li>
                                @endif-->
