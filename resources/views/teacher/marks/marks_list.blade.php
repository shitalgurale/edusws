...
<div>   
        ...
        <div class="col-12">
            <div class="export position-relative mb-4">
                ...
                <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);" onclick="submitTeacherPDFForm()">
                            {{ get_phrase('PDF') }}
                        </a>
                    </li>
                    <li>
    ...
    <form id="teacherPdfDownloadForm" method="GET" target="_blank" action="{{ route('teacher.marks.list_pdf') }}">
    ...
    function submitTeacherPDFForm() {
        document.getElementById('teacherPdfDownloadForm').submit();
    }
    </script>
</div>
