                    ...
                    <div class="row" id = "parent-div" data-plugin="dragula" data-containers='["section-list"]'>
                        <div class="col-md-12">
                            <div class="bg-dragula p-2 p-lg-4">
                                <h5 class="mt-0 d-flex justify-content-between align-items-center"><?php echo get_phrase('List of Lesson'); ?>
                                ...
                                <div id="section-list" class="py-2 draggable-items">
                                    @foreach ($lesson_section as $lesson)
                                        <!-- Item -->
                                        <div class="card mb-0 mt-2 draggable-item" id ="<?php echo $lesson['id']; ?>">
                                            <div class="card-body cursor-pointer">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h5 class="mb-1 mt-0 bg-white">{{ $lesson->title }}</h5>
                                                    </div> <!-- end media-body -->
                                                </div> <!-- end media -->
                                            </div> <!-- end card-body -->
                                        </div> <!-- end col -->
...
<script>
    function sort(id) {
        ...
        var url = "{{ route('teacher.addons.lesson_sort_update', ['id' => ":id"]) }}";
        ...
        $.ajax({
            ...
            {
                toastr.success('<?php  echo get_phrase('Lesson have been Sorted'); ?>');
                setTimeout(function(){
                    location.reload();
                }, 1000);
            },
