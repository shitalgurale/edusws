      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="{{ route('teacher.addons.course_add') }}" class="export_btn">{{ get_phrase('Create new course') }}</a>
          </div>
        </div>
      </div>
    </div>
	        ...
	        <div class="col-md-6">
	          <div class="eCard eCard-special">
	            <div class="eCard-body">
	            	...
	            	<h5 class="eCard-title d-flex justify-content-md-center">{{ count($active) }}</h5>
                        ...
                        <tbody>
                            @foreach ($list as $key => $course)
                                ...
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                        <strong><a class="a-teacher" href="{{ route('teacher.addons.course_edit', ['id' => $course->id]) }}">{{ $course->title }}</a></strong><br>
                                    ...
                                    <div class="dropdown  dropright ">
                                          ...
                                          <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('teacher.addons.course_edit', ['id' => $course->id]) }}">Edit</a></li>
                                            <li><a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('teacher.addons.course_delete', ['id' => $course->id]) }}','undefined')">Delete</a></li>
                                          </ul>
                                        </div>
                                    </td>
                                </tr>
