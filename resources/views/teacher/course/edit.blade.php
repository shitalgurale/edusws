...
<div class="row">
	<div class="col-12">
		<div class="eSection-wrap-2">
			...
			<form class="required-form" action="{{ route('teacher.addons.course_update',['id' => $course->id]) }}" method="post" enctype="multipart/form-data">
				@csrf
              ...
              <span></span>
				...
				<div class="tab-content eNav-Tabs-content" id="myTabContent">
					...
					<div class="tab-pane fade show active" id="cCurriculum" role="tabpanel" aria-labelledby="cCurriculum-tab">
						@include('teacher.course.curriculum')
					</div>
          			...
          			<div class="row fmb-14">
          				...
          				<div class="eCard d-block text-center bg-light col-sm-10 col-md-9 col-lg-6 thumbnail-margin">
          					@if(file_exists( public_path().'/assets/uploads/course_thumbnails/'.$course->thumbnail ) && is_file(public_path().'/assets/uploads/course_thumbnails/'.$course->thumbnail))
          						<img src="{{ asset('assets/uploads/course_thumbnails/'.$course->thumbnail) }}" class="pt-2" width="290px" height="290px"  alt="...">
          					@else
          						<img src="{{ asset('assets/uploads/course_thumbnails/course-thumbnail.png') }}" class="pt-2" width="290px" height="290px"  alt="...">
          					@endif
