            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#">{{ get_phrase('Live classes') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="eForm-layouts">
                            ...
                            <table class="table eTable eTable-2">
                                ...
                                <tr>
                                    ...
                                    {{-- <th scope="col">{{ get_phrase('Meeting info') }}</th> --}}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>
                                            ...
                                            <div class="dAdmin_info_name min-w-full">
                                                <p><span>{{ get_phrase("Meeting id : ") }} </span>{{ $live_class->meeting_id }}</p>
                                                <p><span>{{ get_phrase("Meeting password: "); }}</span>{{ $live_class->meeting_password }}</p>
                                                @if ($live_class->attatchment != ""):
                                                <p><span>{{ get_phrase("Attachment : ") }}</span><a class="text-info" href="{{ asset('public/assets/uploads/live_class/'.$live_class->attatchment); }}" download><strong>{{ get_phrase("Download") }}</strong> </a></p>
                                            @endif
                                            ...
                                            <div class="dAdmin_info_name min-w-full">
                                                ...
                                                <div class="adminTable-action">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2 eDropdown-table-action">
                                                        <!--item-->
                                                        <li><a href="{{ $live_class['live_class_url'] }}" target="blank" class="dropdown-item"> <i class="bi bi-play-circle"></i> {{ get_phrase('Start class') }}</a></li>
                                                        <!--item-->
                                                        <li><a href="javascript:;" class="dropdown-item" data-bs-toggle="tooltip"
                                                        onclick="rightModal('{{ route('teacher.show_edit_modal', ['id' => $live_class->id]) }}',
                                                        '{{ get_phrase('Edit Meeting') }}')">{{ get_phrase('Edit') }}</a></li>
                                                        <!--item-->
                                                        <li><a href="javascript:;" class="dropdown-item" data-bs-toggle="tooltip"
                                                        onclick="confirmModal('{{ route('teacher.live_class_delete_by_meeting_id', ['id' => $live_class->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
