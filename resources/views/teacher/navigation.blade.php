	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li {{ request()->is('teacher/dashboard') ? 'showMenu':'' }}">
              ...
              <!-- Compose-->
            <!--<li class="nav-links-li {{ request()->is('teacher/compose') ? 'showMenu':'' }}">
                <div class="iocn-link">
                    <a href="{{ route('teacher.compose') }}">
                        <div class="sidebar_icon">
            ...
            <!-- OutBox -->
          <!--  <li class="nav-links-li {{ request()->is('teacher/outbox') ? 'showMenu':'' }}">
                  <div class="iocn-link">
                      <a href="{{ route('teacher.outbox') }}">
                          <div class="sidebar_icon">
            ...
            <!-- Inbox -->
            <!--<li class="nav-links-li {{ request()->is('teacher/compose/inbox') ? 'showMenu' : '' }}">
              <a href="{{ route('teacher.inbox') }}" class="d-flex align-items-center justify-content-start">
          ...
          <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu':'' }}">
            ...
            <li class="nav-links-li {{ request()->is('teacher/noticeboard*') || request()->is('teacher/events/list*') || request()->is('teacher/feedback-list*')  ? 'showMenu':'' }}">
    	        ...
    	        <!-- Broadcast -->
    	        <li class="nav-links-li {{ request()->is('teacher/compose') || request()->is('teacher/outbox') || request()->is('teacher/inbox') ? 'showMenu' : '' }}">
                  <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <!-- 📢 Broadcast icon -->
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('teacher/compose') ? 'active' : '' }}" href="{{ route('teacher.compose') }}">
                            {{ get_phrase('Compose') }}
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('teacher/outbox') ? 'active' : '' }}" href="{{ route('teacher.outbox') }}">
                            {{ get_phrase('Outbox') }}
                        </a>
                    </li>
                    <li>
                        <a class="{{ request()->is('teacher/inbox') ? 'active' : '' }}" href="{{ route('teacher.inbox') }}">
                            <div class="d-flex align-items-center">
                                <span>{{ get_phrase('Inbox') }}</span>
                                @if(isset($unreadMessageCount) && $unreadMessageCount > 0)
