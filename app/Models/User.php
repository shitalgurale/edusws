...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'gender', 'role_id', 'parent_id', 'school_id', 'code', 'user_information', 'student_info', 'documents', 'status', 'department_id', 'designation', 'language', 'school_role', 'account_status'
    ];
