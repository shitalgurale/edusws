        ...
        <div class="user-info d-flex flex-column">
            <div class="user-info-basic d-flex flex-column justify-content-center">
                ...
                <div class="userContent text-center">
                    ...
                    <p class="info">{{ get_phrase('Driver') }}</p>
                    ...
                    <div class="eForm-layouts">
                        <form action="{{ route('driver.password', 'update') }}" method="post">
                            ...
                            <div class="fpb-7">
                                ...
                                <input type="password" class="form-control eForm-control" id="new_password"
                                    name="new_password" placeholder="New password" />
                            </div>

                            <div class="fpb-7">
                                <label for="confirm_password"
                                    class="eForm-label">{{ get_phrase('Confirm Password') }}</label>
                                <input type="password" class="form-control eForm-control" id="confirm_password"
                                    name="confirm_password" placeholder="Confirm password" />
                            </div>

                            <div class="fpb-7">
                                <label for="old_password" class="eForm-label">{{ get_phrase('Current Password') }}</label>
                                <input type="password" class="form-control eForm-control" id="old_password"
                                    name="old_password" placeholder="Your current password" />
                            </div>
                            <div class="fpb-7 text-end pt-3">
                                <button type="submit"
                                    class="btn btn-primary text-12px p-2">{{ get_phrase('Change Password') }}</button>
                            </div>
