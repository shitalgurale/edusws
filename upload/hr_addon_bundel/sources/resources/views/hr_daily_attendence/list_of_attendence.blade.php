      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            @if(auth()->user()->role_id == 2)
            <a href="javascript:;" class="export_btn"  onclick="rightModal('{{ route('hr.show_take_attendence_modal') }}','{{ get_phrase('Take Attendence') }}')">{{ get_phrase('Take Attendence') }}</a>
                ...
                <div class="col-md-2">
                    <div class="position-relative">
                        ...
                        >
                          ...
                          <li>
                            <button class="dropdown-item" href="#" onclick="Export()" >PDF</button>
                          </li>
                        </ul>
                      </div>
                </div>
...
"use strict";
  ...
  var getHrDailtyAttendance = function () {
    ...
    if(role_id != "" && month != "" && year != ""){
      $.ajax({
        ...
        url: '{{ route('hr.hr_daily_attendance.filter') }}',
  ...
  var download_csv=function()
  {
    ...
    if(if_table_loaded == 1)
    {
        ...
        var url='{{ route("hr.hrdailyAttendanceFilter_csv", "month,year,role_id") }}';
