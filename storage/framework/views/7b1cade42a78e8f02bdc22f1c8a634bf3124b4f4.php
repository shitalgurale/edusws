...
<body>
	...
	<div class="sidebar">
      ...
      <!-- Inbox -->
    <!--  <li class="nav-links-li <?php echo e(request()->is('parent/compose/inbox') ? 'showMenu' : ''); ?>">
        <div class="iocn-link">
          <a href="<?php echo e(route('parent.inbox')); ?>">
            ...
            <span class="link_name"><?php echo e(get_phrase('Inbox')); ?></span>
            <?php if(isset($unreadMessageCount) && $unreadMessageCount > 0): ?>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                <?php echo e($unreadMessageCount); ?>
...
<!-- Inbox -->
<li class="nav-links-li <?php echo e(request()->is('parent/compose/inbox') ? 'showMenu' : ''); ?>">
  <a href="<?php echo e(route('parent.inbox')); ?>" class="d-flex align-items-center justify-content-start">
    <div class="sidebar_icon d-flex align-items-center position-relative">
      ...
      <span class="link_name ms-2"><?php echo e(get_phrase('Inbox')); ?></span>
    </div>
  </a>
</li>
			...
			<li class="nav-links-li <?php echo e(request()->is('parent/teacherlist*')||request()->is('parent/childlist*') ? 'showMenu':''); ?>">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="<?php echo e((request()->is('parent/teacherlist*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.teacherlist')); ?>"><span><?php echo e(get_phrase('Teacher')); ?></span></a></li>
          <li><a class="<?php echo e((request()->is('parent/childlist*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.childlist')); ?>"><span><?php echo e(get_phrase('Child')); ?></span></a></li>
				</ul>
			</li>

			<li class="nav-links-li <?php echo e(request()->is('parent/attendence/list*') || request()->is('parent/routine*') || request()->is('parent/child/syllabus*')|| request()->is('parent/child/subjects*') || request()->is('student/syllabus*') ? 'showMenu':''); ?>">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="<?php echo e((request()->is('parent/attendence/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.list_of_attendence')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a></li>
					<li><a class="<?php echo e((request()->is('parent/routine*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a></li>
          <li><a class="<?php echo e((request()->is('parent/child/subjects*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a></li>
          <li><a class="<?php echo e((request()->is('parent/child/syllabus*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.syllabus_list')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a></li>
        </ul>
			</li>
      ...
      <?php if(addon_status('transport') == 1): ?>
			...
			<li class="nav-links-li <?php echo e(request()->is('parent/marks') || request()->is('parent/grade') ? 'showMenu':''); ?>">
        <div class="iocn-link">
          <a href="#">
            <div class="sidebar_icon">
        ...
        <ul class="sub-menu">
            <li>
                <a class="<?php echo e((request()->is('parent/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
            </li>
            <li>
                <a class="<?php echo e((request()->is('parent/grade')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.grade_list')); ?>"><span><?php echo e(get_phrase('Grades')); ?></span></a>
            </li>
        </ul>
      </li>
      ...
      <li class="nav-links-li <?php echo e(request()->is('parent/fee_manager*')  ? 'showMenu':''); ?>">
        ...
        <ul class="sub-menu">
            <li>
              <a class="<?php echo e((request()->is('parent/fee_manager*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.fee_manager.list')); ?>">
      ...
      <li class="nav-links-li <?php echo e(request()->is('parent/noticeboard*') || request()->is('parent/events/list*') || request()->is('parent/feedback/filter*') ? 'showMenu':''); ?>">
        <div class="iocn-link">
          <a href="#">
            <div class="sidebar_icon">
        ...
        <ul class="sub-menu">
          <li>
            <a class="<?php echo e((request()->is('parent/noticeboard*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.noticeboard.list')); ?>">
              <span><?php echo e(get_phrase('Noticeboard')); ?></span>
            </a>
          </li>
          <li>
              <a class="<?php echo e((request()->is('parent/events/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.events.list')); ?>">
                <span><?php echo e(get_phrase('Events')); ?></span>
              </a>
          </li>
          <li>
            <a class="<?php echo e((request()->is('parent/feedback/filter*')) ? 'active' : ''); ?>" href="<?php echo e(route('parent.feedback.filter')); ?>"><span><?php echo e(get_phrase('Feedback')); ?>
              ...
              <div class="message">
                ...
                $last_message = DB::table('message_thrades')
                  ...
                  <?php if(!empty($last_message)): ?>
                    <a href="<?php echo e(route('parent.message.all_message', ['id' => $last_message->id])); ?>" class="message_ico">
                  ...
                  <?php else: ?>
                    <a href="<?php echo e(route('parent.message.chat_empty')); ?>" class="message_ico">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M4 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h1v2a1 1 0 0 0 1.707.707L9.414 13H15a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4Z" clip-rule="evenodd"/>
                            <path fill-rule="evenodd" d="M8.023 17.215c.033-.03.066-.062.098-.094L10.243 15H15a3 3 0 0 0 3-3V8h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-1v2a1 1 0 0 1-1.707.707L14.586 18H9a1 1 0 0 1-.977-.785Z" clip-rule="evenodd"/>
                        </svg>
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('parent.password', ['edit'])); ?>">
                            <span>
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/parent/navigation.blade.php ENDPATH**/ ?>