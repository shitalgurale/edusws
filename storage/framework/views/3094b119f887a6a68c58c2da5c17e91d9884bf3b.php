...
<div class="radio-group">
    ...
    <label class="radio-option">
        ...
        <!-- ✅ Parent Form -->
        <form id="form-parent" class="compose-form" method="POST" action="<?php echo e(route('teacher.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
...
<!-- ✅ Student Form -->
<form id="form-student" class="compose-form" method="POST" action="<?php echo e(route('teacher.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
...
<!-- ✅ Both Form -->
<form id="form-both" class="compose-form" method="POST" action="<?php echo e(route('teacher.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
...
function sendPushNotification(message, targetType, formData) {
    ...
    fetch("<?php echo e(route('teacher.broadcast.notification')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('teacher.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/teacher/compose/compose.blade.php ENDPATH**/ ?>