    ...
    <div class="col-12">
      <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        <div class="d-flex flex-column">
          <h4><?php echo e(get_phrase('Monthly Attendance')); ?></h4>
          <ul class="d-flex align-items-center eBreadcrumb-2">
            <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
            <li><a href="#"><?php echo e(get_phrase('Academic')); ?></a></li>
            <li><a href="#"><?php echo e(get_phrase('Monthly Attendance')); ?></a></li>
          </ul>
        </div>
        <div class="export-btn-area">
          <a href="#" class="export_btn" onclick="rightModal('<?php echo e(route('admin.take_attendance.open_modal')); ?>', '<?php echo e(get_phrase('Mark Attendance')); ?>')">
            <?php echo e(get_phrase('Mark Attendance')); ?>
    ...
    <div class="eSection-wrap-2">
        ...
        <div class="att-filter d-flex flex-wrap">
          <div class="att-filter-option">
            <select name="month" id="month" class="form-select eForm-select eChoice-multiple-with-remove" required>
              ...
              <?php for($m = 1; $m <= 12; $m++): ?>
                <option value="<?php echo e(date('M', mktime(0, 0, 0, $m, 1))); ?>"
                  <?php echo e(date('M') == date('M', mktime(0, 0, 0, $m, 1)) ? 'selected' : ''); ?>>
                  <?php echo e(get_phrase(date('F', mktime(0, 0, 0, $m, 1)))); ?>
      ...
      <div class="card-body attendance_content">
        <div class="empty_box text-center">
          ...
          <br>
          <span><?php echo e(get_phrase('Search Attendance Report')); ?></span>
        </div>
      </div>
    </div>
  </div>
...
function updateStudentAttendanceData(month, year, class_id, section_id) {
    let url = "<?php echo e(route('attendance.update_student_attendance_data')); ?>";
...
function exportStudentAttendancePDF() {
    ...
    let url = `<?php echo e(route('attendance.export_student_pdf')); ?>?month=${month}&year=${year}&class_id=${class_id}&section_id=${section_id}`;
...
function download_csv() {
    ...
    form.method = 'POST';
    form.action = "<?php echo e(route('admin.dailyAttendanceFilter_csv')); ?>"; // no placeholders here
    form.target = '_blank';
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/admin/attendance/daily_attendance.blade.php ENDPATH**/ ?>