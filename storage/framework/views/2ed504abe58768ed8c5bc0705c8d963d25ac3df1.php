...
<body>
    ...
    <div class="receipt-container" id="printableDiv">
        <div class="school-info">
            <?php if($school_logo): ?>
                <img src="<?php echo e($school_logo); ?>" alt="School Logo" style="max-width: 80px; display:block; margin:auto;">
            <?php endif; ?>
            <h2 style="font-size: 16px; margin: 5px 0;"><?php echo e($school_name); ?></h2>
            <p style="font-size: 12px; margin: 2px 0;"><?php echo e($school_address); ?></p>
            <p style="font-size: 12px; margin: 2px 0;"><b>Phone:</b> <?php echo e($school_phone); ?> | <b>Email:</b> <?php echo e($school_email); ?></p>
        </div>
        ...
        <!-- ✅ Student Info -->
        <?php if(!empty($student_details) && is_array($student_details) && isset($student_details['user_id'])): ?>
            <table class="table">
                <tr>
                    <th>Student ID</th>
                    <th>Student Name</th>
                ...
                <tr>
                    <td><?php echo e($student_details['user_id'] ?? 'N/A'); ?></td>
                    <td><?php echo e($student_details['name'] ?? 'N/A'); ?></td>
                    <td><?php echo e($student_details['class_name'] ?? ''); ?> - <?php echo e($student_details['section_name'] ?? ''); ?></td>
                    <td><?php echo e($student_details['parent_name'] ?? 'N/A'); ?></td>
                    <td><?php echo e($invoice_details['id'] ?? 'N/A'); ?></td>
        ...
        <?php if($installments->count() > 0): ?>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e(ordinal($index + 1)); ?> Installment</td>
                            <td><?php echo e(date('d-M-Y', strtotime($inst->paid_at))); ?></td>
                            <td><?php echo e(school_currency($inst->amount_paid)); ?></td>
                            <td><?php echo e(ucfirst($inst->payment_method)); ?></td>
                        </tr>
        ...
        <p style="font-size: 14px; margin: 5px 0;"><strong>Amount in Words:</strong> 
            <?php echo e(\App\Helpers\NumberToWordsHelper::convertNumberToWords($invoice_details['paid_amount'])); ?> Rupees Only
        </p>
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/parent/fee_manager/invoice.blade.php ENDPATH**/ ?>