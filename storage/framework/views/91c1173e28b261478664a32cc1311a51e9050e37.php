...
<div class="mark_report_content mark_report" id="mark_history">
    <!--<h4 style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;">
        <?php echo e(get_phrase('Exam Mark')); ?>

    </h4>-->
    <div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
    <h2 style="margin: 0;"><?php echo e(get_phrase('Exam Marks Report')); ?></h2>
    <p style="margin: 5px 0;"><?php echo e(get_phrase('Class')); ?>: <?php echo e($marks_data['class_name'] ?? 'N/A'); ?></p>
    <p style="margin: 5px 0;"><?php echo e(get_phrase('Section')); ?>: <?php echo e($marks_data['section_name'] ?? 'N/A'); ?></p>
    <p style="margin: 5px 0;"><?php echo e(get_phrase('Subject')); ?>: <?php echo e($marks_data['subject_name'] ?? 'N/A'); ?></p>
    <p style="margin: 5px 0;"><?php echo e(get_phrase('Session')); ?>: <?php echo e($marks_data['session_title'] ?? 'N/A'); ?></p>
</div>
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/admin/marks/markPdf.blade.php ENDPATH**/ ?>