                    ...
                    <div class="col-md-2">
                      <div class="position-relative">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                          ...
                          <li>
                              <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('class_routine_content')"><?php echo e(get_phrase('Print')); ?></a>
                          </li>
                        </ul>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  "use strict";
    ...
    var getFilteredClassRoutine = function() {
        ...
        var section_id = $('#section_id').val();
        if(class_id != "" && section_id!= ""){
            let url = "<?php echo e(route('teacher.routine.routine_list')); ?>";
            $.ajax({
                url: url,
                headers: {
...
<?php echo $__env->make('teacher.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/teacher/routine/routine_list.blade.php ENDPATH**/ ?>