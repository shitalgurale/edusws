      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <?php if(auth()->user()->role_id == 2): ?>
            <a href="javascript:;" class="export_btn"  onclick="rightModal('<?php echo e(route('hr.show_take_attendence_modal')); ?>','<?php echo e(get_phrase('Mark Attendance')); ?>')"><?php echo e(get_phrase('Mark Attendance')); ?></a>
            ...
            <div class="row mt-3 d-print-none">
                ...
                <div class="col-md-2 mb-1">
                    <select name="month" id="month" class="form-select eForm-select eChoice-multiple-with-remove" required>
                        <option value="">
                            <?php echo e(get_phrase('Select a month')); ?>

                        </option>
                        <option value="Jan" <?php echo e(date('M') =='Jan' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('January')); ?>

                        </option>
                        <option value="Feb" <?php echo e(date('M') =='Feb' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('February')); ?>

                        </option>
                        <option value="Mar" <?php echo e(date('M') =='Mar' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('March')); ?>

                        </option>
                        <option value="Apr" <?php echo e(date('M') =='Apr' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('April')); ?>

                        </option>
                        <option value="May" <?php echo e(date('M') =='May' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('May')); ?>

                        </option>
                        <option value="Jun" <?php echo e(date('M') =='Jun' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('June')); ?>

                        </option>
                        <option value="Jul" <?php echo e(date('M') =='Jul' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('July')); ?>

                        </option>
                        <option value="Aug" <?php echo e(date('M') =='Aug' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('August')); ?>

                        </option>
                        <option value="Sep" <?php echo e(date('M') =='Sep' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('September')); ?>

                        </option>
                        <option value="Oct" <?php echo e(date('M') =='Oct' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('October')); ?>

                        </option>
                        <option value="Nov" <?php echo e(date('M') =='Nov' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('November')); ?>

                        </option>
                        <option value="Dec" <?php echo e(date('M') =='Dec' ? 'selected' :''); ?>>
                            <?php echo e(get_phrase('December')); ?>
                ...
                <div class="col-md-2 mb-1">
                    <select name="year" id="year" class="form-select eForm-select eChoice-multiple-with-remove" required>
                        <option value="">
                            <?php echo e(get_phrase('Select a year')); ?>

                        </option>
                        <?php for($year = 2015; $year <= date('Y'); $year++){ ?>
                        <option value="<?php echo e($year); ?>" <?php echo e(date('Y') == $year ? 'selected' :''); ?>>
                            <?php echo e($year); ?>
...
function getHrDailyAttendance() {
    ...
    if (role_id !== "" && month !== "" && year !== "") {
        $.ajax({
            url: '<?php echo e(route('hr.hr_daily_attendance.filter')); ?>', // Replace with actual backend route
            type: "GET",
...
function exportEmployeeAttendancePDF() {
    if (if_table_loaded == 1) {
        ...
        toastr.error('<?php echo e(get_phrase('No data Found')); ?>');
    }
}
function download_csv() {
    ...
    if (!month || !year || !role_id) {
        toastr.error('Please select Month, Year and Role.');
        return;
    }
    ...
    const exportUrl = '<?php echo e(route("hr.hrdailyAttendanceFilter_csv")); ?>?' + params.toString();
...
<?php echo $__env->make($roleName, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/hr_daily_attendence/list_of_attendence.blade.php ENDPATH**/ ?>