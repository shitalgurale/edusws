...
<div class="radio-group">
    <label class="radio-option">
        ...
        <span><?php echo e(get_phrase('Parents')); ?></span>
    </label>

    <label class="radio-option">
        <input type="radio" name="user_type" value="student" onclick="selectTab('student', this)">
        <span><?php echo e(get_phrase('Students')); ?></span>
    </label>

    <label class="radio-option">
        <input type="radio" name="user_type" value="both" onclick="selectTab('both', this)">
        <span><?php echo e(get_phrase('Both')); ?></span>
    </label>

    <label class="radio-option">
        <input type="radio" name="user_type" value="teacher" onclick="selectTab('teacher', this)">
        <span><?php echo e(get_phrase('Teachers')); ?></span>
    </label>
</div>


<!-- ✅ Parent Form -->
<form id="form-parent" class="compose-form" method="POST" action="<?php echo e(route('admin.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="class_id_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Class')); ?></label>
    ...
    <!-- Select Section -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="section_id_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Section')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Parents -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="parent_id_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Parents')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Subject -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="subject_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Subject')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Message -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="message_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Message')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Attachment -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="attachment_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Attachment')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Notification -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="notification_parent" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Notification')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
...
<!-- ✅ Student Form -->
<form id="form-student" class="compose-form" method="POST" action="<?php echo e(route('admin.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="recipient_type" value="student">

    <!-- Select Class -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="class_id_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Class')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Section -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="section_id_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Section')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Student -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="student_id_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Students')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Subject -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="subject_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Subject')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Message -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="message_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Message')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Attachment -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="attachment_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Attachment')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Notification -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="notification_student" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Notification')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
...
<!-- ✅ Both Form -->
<form id="form-both" class="compose-form" method="POST" action="<?php echo e(route('admin.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="recipient_type" value="both">

    <!-- Select Class -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="class_id_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Class')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Section -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="section_id_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Section')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Parents -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="parent_id_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Parents')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Students -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="student_id_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Students')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Subject -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="subject_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Subject')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Message -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="message_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Message')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Attachment -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="attachment_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Attachment')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Notification -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="notification_both" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Notification')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
...
<!-- ✅ Teacher Form -->
<form id="form-teacher" class="compose-form" method="POST" action="<?php echo e(route('admin.send_mail')); ?>" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="recipient_type" value="teacher">

    <!-- Select Class -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="class_id_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Class')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Section -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="section_id_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Section')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Select Teachers -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="teacher_id_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Select Teachers')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Subject -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="subject_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Subject')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Message -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="message_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Message')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Attachment -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="attachment_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Attachment')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
    ...
    <!-- Notification -->
    <div class="form-group row fmb-14 justify-content-between align-items-center">
        <label for="notification_teacher" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Notification')); ?></label>
        <div class="col-sm-10 col-md-9 col-lg-10">
...
function sendFormWithNotification(formId, targetType) {
    ...
    fetch("<?php echo e(route('admin.send_mail')); ?>", {
        method: 'POST',
        headers: {
...
function sendPushNotification(message, targetType, form) {
    ...
    fetch("<?php echo e(route('admin.broadcast.notification')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/admin/compose/compose.blade.php ENDPATH**/ ?>