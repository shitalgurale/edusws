    ...
    <div class="row">
      ...
      <div class="col-sm-6 mb-3 px-2">
        <div class="card-block h-100" style="background-color: #1abc9c;">
          ...
          <div class="card-footer-link">
           <!-- <span>View More</span>
            <a href="<?php echo e(route('admin.student')); ?>"><i class="fas fa-arrow-right"></i></a>-->
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 mb-3 px-2">
        <div class="card-block h-100" style="background-color: #3498db;">
          ...
          <div class="card-footer-link">
            <!--<span>View More</span>
            <a href="<?php echo e(route('admin.teacher')); ?>"><i class="fas fa-arrow-right"></i></a>-->
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 mb-3 px-2">
        <div class="card-block h-100" style="background-color: #e74c3c;">
          ...
          <div class="card-footer-link">
       <!--     <span>View More</span>
            <a href="<?php echo e(route('admin.parent')); ?>"><i class="fas fa-arrow-right"></i></a>-->
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 mb-3 px-2">
        <div class="card-block h-100" style="background-color: #9b59b6;">
          ...
          <div class="card-footer-link">
          <!--  <span>View More</span>
            <a href="<?php echo e(route('hr.showAllStaff')); ?>"><i class="fas fa-arrow-right"></i></a>-->
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-6">
    <div class="card shadow p-3 d-flex flex-column justify-content-between h-100" style="background: #e74c3c; color: #fff;">
      <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <a href="<?php echo e(route('teacher.events.list')); ?>" class="text-white text-decoration-underline"><?php echo e(get_phrase('See all')); ?></a>
      </div>
...
<?php echo $__env->make('teacher.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/teacher/dashboard.blade.php ENDPATH**/ ?>