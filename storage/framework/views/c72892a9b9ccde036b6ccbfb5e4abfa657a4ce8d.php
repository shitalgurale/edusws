             ...
             <div class="row">
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-xl-2 mb-3">
                        <button type="button" class="btn btn-icon btn-secondary" onclick="filter_marks()"><?php echo e(get_phrase('Filter')); ?></button>
                    </div>
...
<?php echo $__env->make('teacher.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/teacher/marks/index.blade.php ENDPATH**/ ?>