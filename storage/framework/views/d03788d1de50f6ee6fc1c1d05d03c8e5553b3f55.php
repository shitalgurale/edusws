...
<div class="row">
    ...
    <form action="<?php echo e(route('admin.student.filter')); ?>" method="GET" class="position-relative filter-option d-flex">
...
<div class="filter-export-area d-flex align-items-center">
    <form action="<?php echo e(route('admin.student.filter')); ?>" method="GET" class="position-relative filter-option d-flex">
        ...
        <?php endif; ?>
            ...
            <div class="position-relative me-2">
                <select class="form-select" id="filter_by" onchange="onFilterByChange(this.value)">
                    <option value=""><?php echo e(get_phrase('Filter By')); ?></option>
                    <option value="religion"><?php echo e(get_phrase('Religion')); ?></option>
                    <option value="gender"><?php echo e(get_phrase('Gender')); ?></option>
                    <option value="caste"><?php echo e(get_phrase('Caste')); ?></option>
                </select>
            </div>
            ...
            <div class="position-relative me-2" id="filter_value_container" style="display: none;">
                <select class="form-select" id="filter_value" name="filter_value">
                    <option value=""><?php echo e(get_phrase('Select Value')); ?></option>
            ...
            <div class="position-relative me-2">
                <select class="form-select" name="class_id" id="class_id" onchange="classWiseSection(this.value)" required>
                    <option value=""><?php echo e(get_phrase('Class')); ?></option>
                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($class->id); ?>" <?php echo e((!empty($class_id) && $class_id == $class->id) ? 'selected' : ''); ?>>
                            <?php echo e($class->name); ?>
            ...
            <div class="position-relative me-2">
                <select class="form-select" name="section_id" id="section_id">
                    <option value=""><?php echo e(get_phrase('Section')); ?></option>
                    <?php if(!empty($class_id)): ?>
                        <?php $__currentLoopData = \App\Models\Section::where('class_id', $class_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($section->id); ?>" <?php echo e((!empty($section_id) && $section_id == $section->id) ? 'selected' : ''); ?>>
                                <?php echo e($section->name); ?>
        ...
        <select name="session_id" id="session_id" class="form-select" required>
            <option value=""><?php echo e(get_phrase('Session')); ?></option>
            <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($session->id); ?>" <?php echo e((!empty($session_id) && $session_id == $session->id) ? 'selected' : ''); ?>>
                    <?php echo e($session->session_title); ?>
...
<?php if(!empty($session_id)): ?>
  ...
  ?>
  <h5 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Session')); ?>: <?php echo e($selected_session->session_title ?? '-'); ?></h5>
<?php elseif(!empty($current_session)): ?>
  <h5 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Session')); ?>: <?php echo e($current_session->session_title); ?></h5>
<?php endif; ?>
  <table class="table eTable eTable-2">
    <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col"><?php echo e(get_phrase('Name')); ?></th>
                    <th scope="col"><?php echo e(get_phrase('Student ID')); ?></th>
                    <th scope="col"><?php echo e(get_phrase('Bio ID')); ?></th>
                   <!-- <th scope="col"><?php echo e(get_phrase('Email')); ?></th>-->
                       ...
                       <!-- <td>
                        ...
                        <td>
                          <div class="dAdmin_info_name">
                            <p><?php echo e($student_details->user_id ?? '-'); ?></p>
                          </div>
                        </td>
                        <td>
                          <div class="dAdmin_info_name">
                        ...
                        <td>
                          <?php echo e(isset($student->account_status) && $student->account_status === 'disable' ? get_phrase('Disabled') : get_phrase('Enable')); ?>
...
*/
  ...
  function onFilterByChange(type) {
    ...
    filterDropdown.innerHTML = '<option value=""><?php echo e(get_phrase("Select Value")); ?></option>';
