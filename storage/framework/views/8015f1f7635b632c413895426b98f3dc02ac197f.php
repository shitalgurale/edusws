<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.driver.create')); ?>">
        <?php echo csrf_field(); ?>
        <div class="form-row">
            <div class="fpb-7">
            ...
            <div class="fpb-7">
                ...
                <input type="password" class="form-control eForm-control" id="password" name="password"
                    placeholder="Provide driver password" required>
            </div>

            <div class="fpb-7">
                <label for="birthday" class="eForm-label"><?php echo e(get_phrase('Birthday')); ?><span
        ...
        <div class="fpb-7">
            ...
            <textarea class="form-control eForm-control" id="address" name="address" rows="5"
                placeholder="Provide teacher address" required></textarea>
        </div>
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/admin/transport/drivers/add_driver.blade.php ENDPATH**/ ?>