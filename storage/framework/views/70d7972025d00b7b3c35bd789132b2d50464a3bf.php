...
<div>   
    ...
    <div class="att-report-summary order-1">
        ...
        <p class="summary-item"><?php echo e(get_phrase('Class')); ?> : <span><?php echo e($marks_data['class_name'] ?? ''); ?></span></p>
        <p class="summary-item"><?php echo e(get_phrase('Section')); ?> : <span><?php echo e($marks_data['section_name'] ?? ''); ?></span></p>
        <p class="summary-item"><?php echo e(get_phrase('Subject')); ?> : <span><?php echo e($marks_data['subject_name'] ?? ''); ?></span></p>
    </div>
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(asset('assets/csv_file/marks_preview.csv')); ?>" class="btn btn-success btn-sm">
                    <?php echo e(get_phrase('Example CSV file')); ?> <i class="bi bi-download"></i>
                </a>

                <button type="button" class="btn btn-dark btn-sm bi bi-eye" 
                    onclick="largeModal('<?php echo e(route('admin.marks.csv_preview')); ?>', '<?php echo e(get_phrase('CSV Format Preview')); ?>');" 
                    data-toggle="tooltip" title="<?php echo e(get_phrase('Preview CSV format')); ?>">
                </button>
            </div>

            <!-- Export dropdown on right -->
            <div class="export position-relative">
                ...
                <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                    <li>
                        <a class="dropdown-item" href="<?php echo e(route('admin.marks.list_pdf', [
                            'section_id' => $marks_data['section_id'],
                            'class_id' => $marks_data['class_id'],
                            'session_id' => $marks_data['session_id'],
                            'exam_category_id' => $marks_data['exam_category_id'],
                            'subject_id' => $marks_data['subject_id']
                        ])); ?>">
                            <?php echo e(get_phrase('PDF')); ?>

                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="javascript:;" onclick="printableDiv('mark_history')">
                            <?php echo e(get_phrase('Print')); ?>
...
<div class="row mt-3">
    <div class="col-12">
        <div class="export position-relative mb-4">
            ...
            <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                <li>
                    <a class="dropdown-item" href="<?php echo e(route('admin.marks.list_pdf', ['section_id' => $marks_data['section_id'], 'class_id' => $marks_data['class_id'], 'session_id' => $marks_data['session_id'], 'exam_category_id' => $marks_data['exam_category_id'], 'subject_id' => $marks_data['subject_id'] ])); ?>">
                        <?php echo e(get_phrase('PDF')); ?>
...
<form action="<?php echo e(route('admin.marks.upload')); ?>" method="POST" enctype="multipart/form-data" class="mb-4">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="class_id" value="<?php echo e($marks_data['class_id']); ?>">
    <input type="hidden" name="section_id" value="<?php echo e($marks_data['section_id']); ?>">
    <input type="hidden" name="subject_id" value="<?php echo e($marks_data['subject_id']); ?>">
    <input type="hidden" name="session_id" value="<?php echo e($marks_data['session_id']); ?>">
    <input type="hidden" name="exam_category_id" value="<?php echo e($marks_data['exam_category_id']); ?>">

    <div class="row g-3 align-items-center">
        <div class="col-auto">
            <label for="csv_file" class="form-label"><?php echo e(get_phrase('Upload Marks CSV')); ?></label>
        </div>
        <div class="col-auto">
            <input type="file" name="csv_file" id="csv_file" class="form-control" accept=".csv" required>
        </div>
        <div class="col-auto">
            <button type="submit" class="btn btn-primary"><?php echo e(get_phrase('Upload')); ?></button>
        </div>
    </div>
</form>
    ...
    <table class="table eTable table-bordered">
        <thead>
            <tr>
                ...
                <th><?php echo e(get_phrase('Mark')); ?></th>
                <th><?php echo e(get_phrase('Grade point')); ?></th>
                <th><?php echo e(get_phrase('Comment')); ?></th>
        ...
        <?php $__currentLoopData = $enroll_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enroll_student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button class="btn btn-success" onclick="mark_update('<?php echo e($enroll_student->user_id); ?>')">
...
<?php endif; ?>
    ...
    function mark_update(student_id) {
        var class_id = '<?php echo e($marks_data['class_id'] ?? ''); ?>';
        var section_id = '<?php echo e($marks_data['section_id'] ?? ''); ?>';
        var subject_id = '<?php echo e($marks_data['subject_id'] ?? ''); ?>';
        var session_id = '<?php echo e($marks_data['session_id'] ?? ''); ?>';
        var exam_category_id = '<?php echo e($marks_data['exam_category_id'] ?? ''); ?>';
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/admin/marks/marks_list.blade.php ENDPATH**/ ?>