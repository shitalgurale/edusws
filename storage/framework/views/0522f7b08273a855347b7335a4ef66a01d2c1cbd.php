	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li <?php echo e(request()->is('teacher/dashboard') ? 'showMenu':''); ?>">
              ...
              <!-- Compose-->
            <!--<li class="nav-links-li <?php echo e(request()->is('teacher/compose') ? 'showMenu':''); ?>">
                <div class="iocn-link">
                    <a href="<?php echo e(route('teacher.compose')); ?>">
                        <div class="sidebar_icon">
            ...
            <!-- OutBox -->
          <!--  <li class="nav-links-li <?php echo e(request()->is('teacher/outbox') ? 'showMenu':''); ?>">
                  <div class="iocn-link">
                      <a href="<?php echo e(route('teacher.outbox')); ?>">
                          <div class="sidebar_icon">
            ...
            <!-- Inbox -->
            <!--<li class="nav-links-li <?php echo e(request()->is('teacher/compose/inbox') ? 'showMenu' : ''); ?>">
              <a href="<?php echo e(route('teacher.inbox')); ?>" class="d-flex align-items-center justify-content-start">
            ...
            <li class="nav-links-li <?php echo e(request()->is('teacher/addons/courses*') ? 'showMenu':''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e((request()->is('teacher/addons/courses*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.addons.courses')); ?>">
                        <div class="sidebar_icon">
          ...
          <li class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu':''); ?>">
            ...
            <li class="nav-links-li <?php echo e(request()->is('teacher/noticeboard*') || request()->is('teacher/events/list*') || request()->is('teacher/feedback-list*')  ? 'showMenu':''); ?>">
	            <div class="iocn-link">
	                <a href="#">
	                    <div class="sidebar_icon">
	            ...
	            <ul class="sub-menu">
                  ...
                  <li>
                    <a class="<?php echo e((request()->is('teacher/feedback-list*')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.feedback.feedback_list')); ?>"><span><?php echo e(get_phrase('Feedback')); ?>
    	        ...
    	        <!-- Broadcast -->
    	        <li class="nav-links-li <?php echo e(request()->is('teacher/compose') || request()->is('teacher/outbox') || request()->is('teacher/inbox') ? 'showMenu' : ''); ?>">
                  <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <!-- 📢 Broadcast icon -->
                    ...
                    <span class="arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="4.743" height="7.773" viewBox="0 0 4.743 7.773">
                            <path d="M1.466.247,4.5,3.277a.793.793,0,0,1,.189.288.92.92,0,0,1,0,.643A.793.793,0,0,1,4.5,4.5L1.47,7.53a.828.828,0,0,1-1.218,0,.875.875,0,0,1,0-1.219L2.668,3.886.247,1.466A.828.828,0,0,1,0,.856.828.828,0,0,1,.856,0a.828.828,0,0,1,.61.247Z" fill="#fff"/>
                        </svg>
                    </span>
                </div>
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('teacher/compose') ? 'active' : ''); ?>" href="<?php echo e(route('teacher.compose')); ?>">
                            <?php echo e(get_phrase('Compose')); ?>

                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('teacher/outbox') ? 'active' : ''); ?>" href="<?php echo e(route('teacher.outbox')); ?>">
                            <?php echo e(get_phrase('Outbox')); ?>

                        </a>
                    </li>
                    <li>
                        <a class="<?php echo e(request()->is('teacher/inbox') ? 'active' : ''); ?>" href="<?php echo e(route('teacher.inbox')); ?>">
                            <div class="d-flex align-items-center">
                                <span><?php echo e(get_phrase('Inbox')); ?></span>
                                <?php if(isset($unreadMessageCount) && $unreadMessageCount > 0): ?>
                                    <span class="ms-2 badge bg-danger" style="font-size: 0.65rem;">
                                        <?php echo e($unreadMessageCount); ?>
              ...
              <div class="message">
                ...
                $last_message = DB::table('message_thrades')
                  ...
                  <?php if(!empty($last_message)): ?>
                    <a href="<?php echo e(route('teacher.message.all_message', ['id' => $last_message->id])); ?>" class="message_ico">
                  ...
                  <?php else: ?>
                    <a href="<?php echo e(route('teacher.message.chat_empty')); ?>" class="message_ico">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M4 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h1v2a1 1 0 0 0 1.707.707L9.414 13H15a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4Z" clip-rule="evenodd"/>
                            <path fill-rule="evenodd" d="M8.023 17.215c.033-.03.066-.062.098-.094L10.243 15H15a3 3 0 0 0 3-3V8h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-1v2a1 1 0 0 1-1.707.707L14.586 18H9a1 1 0 0 1-.977-.785Z" clip-rule="evenodd"/>
                        </svg>
...
<?php /**PATH /home/siliconcpanel/public_html/edusws.appstime.in/resources/views/teacher/navigation.blade.php ENDPATH**/ ?>