...
Route::get('hr/attendance/csv', [HrController::class, 'hrdailyAttendanceFilter_csv'])->name('hr.hrdailyAttendanceFilter_csv');
...
Route::controller(HrController::class)->group(function () {
    ...
    Route::get('/hr/user/list/staff_list', 'showAllStaff')->name('hr.showAllStaff');
    ...
    Route::get('/hr/hr_daily_attendance/all_roles', 'getAllRolesAttendance')->name('hr.hr_daily_attendance.all_roles');
    Route::get('/hr/daily-attendance/filter', 'filter')->name('hr.hrdailyAttendanceFilter');
    
  // Route::post('/attendance/employee/export-csv', [HrController::class, 'exportEmployeeAttendanceCSV'])->name('admin.exportHrMonthlyCSV');
